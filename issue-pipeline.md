...
6. Create a brief implementation plan (account for ALL available tools: Bash to run tests/compile/lint, Read/Grep/Glob to explore code, Edit/Write to modify files)
